  ...
  return (
    <main className="bg-background text-foreground">
      <article className="mx-auto w-full max-w-3xl px-5 py-16 md:py-24">
        ...
        <GlassCard className="relative mt-8 overflow-hidden p-0">
        ...
        <footer className="mt-10 flex items-center justify-between">
          <a href="/blogs" className="inline-flex items-center justify-center rounded-full border border-white/15 bg-white/30 px-3 py-1.5 text-sm font-medium text-foreground/90 shadow-sm backdrop-blur transition-colors hover:bg-white/40">← Back to Blog</a>
